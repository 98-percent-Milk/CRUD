...
def test_menu_option_one():
    ...
    with mock.patch.object(builtins, 'input', side_effect=['1', 'ruby', 'Gem', '6']):
        main()
...
def test_menu_option_three():
    ...
    with mock.patch.object(builtins, 'input', side_effect=['3','ruby', 'ruby', 'New Gem', '6']):
        main()

def test_menu_option_four():
    """ Unit test for choosing option four from menu """
    with mock.patch.object(builtins, 'input', side_effect=['4', '2', '6']):
        main()